...
- Analyzed survival rates by class, sex, and age group using pandas
- Built an interactive dashboard (Looker Studio) with filters for class and sex
- Used the Groq LLM API to auto-generate plain-English insight summaries from the analysis, reducing manual reporting effort

## Tools used
Python, Pandas, Looker Studio, Groq API
